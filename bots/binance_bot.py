...
class BinanceBot:
    ...
    def GetData(self,s='BTCUSDT'): 
        ...
        if self.symbol == 'empty':
            ...
            candles = client.get_historical_klines(symbol=self.symbol, interval = Client.KLINE_INTERVAL_15MINUTE, start_str="20 Ago, 2019")
            ...
            final_dataframe.to_csv(path_or_buf="dataframes/BTCUSDT.csv", index=False)
